...
| configuration.settings.manage | Systemeinstellungen verwalten | 10 | configuration-integrations<br>configuration-integrations.show<br>configuration-integrations.update<br>configuration-integrations.test<br>configuration-settings<br>configuration-settings.store<br>configuration-settings.create<br>configuration-settings.group-update<br>configuration-settings.update<br>configuration-settings.edit |
...
| --- | ---: | --- |
| Rollen-geschützt | 99 | Nur Routen mit mindestens einem can:-Middleware Eintrag |
| Ungefiltert | 24 | Werden in dieser Auswertung nicht als rollenabhängig bewertet |

## 2) Rollenreichweite
| Rolle | Label | Sichtbare Routen |
| --- | --- | ---: |
| admin | Administrator | 99 |
| leiter | Leiter | 89 |
| operations | Mitarbeiter Operations | 65 |
| support | Support | 7 |
| configuration | Konfiguration | 23 |
...
| --- | --- |
| admin | Aufträge, Sendungen, Kommissionierlisten, CSV-Export, Systemeinstellungen, Monitoring · system-status, Monitoring · system-jobs, Monitoring · tracking, Verwaltung · identity-users, Verwaltung · notifications, Logs · system-logs, Logs · audit-logs, Logs · domain-events |
| leiter | Aufträge, Sendungen, Kommissionierlisten, CSV-Export, Monitoring · system-status, Monitoring · system-jobs, Monitoring · tracking, Verwaltung · identity-users, Verwaltung · notifications, Logs · system-logs, Logs · audit-logs, Logs · domain-events |
| operations | Aufträge, Sendungen, Kommissionierlisten, CSV-Export, Monitoring · system-status, Monitoring · system-jobs, Monitoring · tracking, Verwaltung · identity-users, Verwaltung · notifications, Logs · system-logs, Logs · audit-logs, Logs · domain-events |
...
| configuration | Systemeinstellungen, Monitoring · system-status, Monitoring · system-jobs, Monitoring · tracking, Verwaltung · identity-users, Verwaltung · notifications, Logs · system-logs, Logs · audit-logs, Logs · domain-events |
...
| viewer | Aufträge, Monitoring · system-status, Monitoring · system-jobs, Monitoring · tracking, Verwaltung · identity-users, Verwaltung · notifications, Logs · system-logs, Logs · audit-logs, Logs · domain-events |

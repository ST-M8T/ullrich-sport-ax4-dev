...
return [
    ...
    */
    ...
    'dhl_auth' => [
        'base_url' => env('DHL_AUTH_BASE_URL', 'https://api-sandbox.dhl.com'),
        'username' => env('DHL_AUTH_USERNAME', ''),
        'password' => env('DHL_AUTH_PASSWORD', ''),
        'path' => env('DHL_AUTH_PATH', '/auth/v1/token'),
    ...
    'dhl_freight' => [
        'base_url' => env('DHL_FREIGHT_BASE_URL', 'https://api-sandbox.dhl.com/freight'),
        'api_key' => env('DHL_FREIGHT_API_KEY', ''),
        'api_secret' => env('DHL_FREIGHT_API_SECRET', ''),
        'auth' => env('DHL_FREIGHT_AUTH', 'bearer'),
        'api_key_header' => env('DHL_FREIGHT_API_KEY_HEADER', 'DHL-API-Key'),
        'api_secret_header' => env('DHL_FREIGHT_API_SECRET_HEADER', null),
        'paths' => [
            'timetable' => env('DHL_FREIGHT_TIMETABLE_PATH', '/timetable/gettimetable'),
            'products' => env('DHL_FREIGHT_PRODUCTS_PATH', '/products'),
            'additional_services' => env('DHL_FREIGHT_ADDITIONAL_SERVICES_PATH', '/products/{productId}/additionalservices'),
            'additional_services_validation' => env('DHL_FREIGHT_ADDITIONAL_SERVICES_VALIDATION_PATH', '/products/{productId}/additionalservices/validationresults'),
            'shipments' => env('DHL_FREIGHT_SHIPMENTS_PATH', '/sendtransportinstruction'),
            'price_quote' => env('DHL_FREIGHT_PRICE_QUOTE_PATH', '/pricequote/quoteforprice'),
            'label' => env('DHL_FREIGHT_LABEL_PATH', '/print/printdocumentsbyid'),
            'print_documents' => env('DHL_FREIGHT_PRINT_DOCUMENTS_PATH', '/print/printdocuments'),
            'print_multiple_documents' => env('DHL_FREIGHT_PRINT_MULTIPLE_DOCUMENTS_PATH', '/print/printmultipledocuments'),
        ],

...
return [
    ...
    */
    ...
    'dhl_freight' => [
        ...
        'paths' => [
            'timetable' => $dhlString('DHL_FREIGHT_TIMETABLE_PATH', '/info/time-table/v1/gettimetable'),
            'products' => $dhlString('DHL_FREIGHT_PRODUCTS_PATH', '/info/products/services/v1/products'),
            'additional_services' => $dhlString('DHL_FREIGHT_ADDITIONAL_SERVICES_PATH', '/info/products/services/v1/products/{productId}/additionalservices'),
            'additional_services_validation' => $dhlString('DHL_FREIGHT_ADDITIONAL_SERVICES_VALIDATION_PATH', '/info/products/services/v1/products/{productId}/additionalservices/validationresults'),
            'shipments' => $dhlString('DHL_FREIGHT_SHIPMENTS_PATH', '/shipping/orders/v1/sendtransportinstruction'),
            'price_quote' => $dhlString('DHL_FREIGHT_PRICE_QUOTE_PATH', '/info/pricequote/v1/quoteforprice'),
            'label' => $dhlString('DHL_FREIGHT_LABEL_PATH', '/shipping/labels/v1/printdocumentsbyid'),
            'print_documents' => $dhlString('DHL_FREIGHT_PRINT_DOCUMENTS_PATH', '/shipping/labels/v1/printdocuments'),
            'print_multiple_documents' => $dhlString('DHL_FREIGHT_PRINT_MULTIPLE_DOCUMENTS_PATH', '/shipping/labels/v1/printmultipledocuments'),
        ],

...
/**
 * Fulfillment Masterdata Packaging Section View Composer
 * Bereitet Packaging-Section-Daten vor
 */
final class FulfillmentMasterdataPackagingSectionComposer
{
    ...
    public function compose(View $view): void
    {
        ...
        $sectionData = $this->masterdataSectionService->preparePackagingSection($catalog, 10);

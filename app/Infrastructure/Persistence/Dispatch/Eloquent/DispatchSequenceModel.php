...
final class DispatchSequenceModel extends Model
{
    public const LIST_SEQUENCE = 'dispatch_lists';

    public const SCAN_SEQUENCE = 'dispatch_scans';

    protected $table = 'dispatch_sequences';

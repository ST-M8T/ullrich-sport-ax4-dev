...
final class DatabaseShipmentEventReportRepository implements ShipmentEventReportRepository
{
    /**
    ...
    {
        $inserted = DB::table('reporting_shipment_events')->insertOrIgnore([array_merge([
            'event_id' => $eventId,
        ], $attributes)]);

        DB::table('reporting_shipment_events')
